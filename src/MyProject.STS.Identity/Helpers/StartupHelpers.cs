...
namespace MyProject.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
            ...
            where TKey : IEquatable<TKey>
        {
            ...
            var cultureConfiguration =
                configuration.GetSection(nameof(CultureConfiguration)).Get<CultureConfiguration>();
            ...
            where TConfigurationDbContext : DbContext, IAdminConfigurationDbContext
        {
            ...
            services.RegisterNpgSqlDbContexts<TIdentityDbContext, TConfigurationDbContext, TPersistedGrantDbContext>(
                identityConnectionString, configurationConnectionString, persistedGrantsConnectionString);
        }
